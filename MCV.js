srcs = ["./Assets/submitted/1.png","./Assets/submitted/2.jpg","./Assets/submitted/3.jpg","./Assets/submitted/4.jpg","./Assets/submitted/5.jpg","./Assets/submitted/6.jpg","./Assets/submitted/7.jpg","./Assets/submitted/8.jpg","./Assets/submitted/9.jpg","./Assets/submitted/10.jpg","./Assets/submitted/11.jpg","./Assets/submitted/12.jpg","./Assets/submitted/13.jpg","./Assets/submitted/14.jpg","./Assets/submitted/15.jpeg","./Assets/submitted/16.jpg","./Assets/submitted/EmotionsSeries1 AJ.png","./Assets/submitted/EmotionsSeries2 AJ.png","./Assets/submitted/EmotionsSeries5 AJ.png","./Assets/submitted/EmotionsSeries8 AJ.png","./Assets/submitted/Tutu1.png","./Assets/submitted/Tutu2.png","./Assets/submitted/Tutu3.png",
"./Assets/submitted/IJA (1).jpg","./Assets/submitted/IJA (2).jpg","./Assets/submitted/IJA (3).jpg"
...
titles = ["Win or Lose","Hope","Fairly Valley","Moonshot","Golden Hour","Neighbour's Little Flower","Food for Mental Health","Crepuscule","The Blue Sky Walk","The Peaceful Beach","Dusk's Rose","A Rose Swaying In A Sea of Flames","Life goes on","Love yourself","Tide","从万丈深渊 自己治愈自己 (Saving myself from the abyss)","Emotions Series 1","Emotions Series 2","Emotions Series 5","Emotions Series 8","Pottery Craft 1","Pottery Craft 2","Pottery Craft 3","Monotonous Kafkaesque","Desert Tundra","Flight of Happiness"
...
authors = ["SCOOB DAUG","Yoong Hui Hui","Lily C","Anonymous","Low Wei Lun","YüJun :)","Low Wei Lun","Sisyphus7","Low Wei Lun","Anonymous","YY","YüJun :)","Isuann L.","Spring breeze","Anonymous","Liu Wei Zi","artjamila","artjamila","artjamila","artjamila","Anonymous","Anonymous","Anonymous","Prabh Lahari","Prabh Lahari","Prabh Lahari"
...
des=[["This digital artwork helps me release stress by showcasing the absurdity of unhinged confidence and how it can affect people who overestimate themselves. Overconfidence might be a bad thing, a poison that leads to bigotry and ignorance. I have learned that confidence is a double-edged sword which can be my ally or enemy at times. Confidence is something abstract that can't be seen. I have learned to take everything with a pinch of salt and not to assume that anything that appears easy is actually easy. Nothing is truly easy because the perception of something being easy can often lead me to overlook the simplest problems. Thus, be cautious and never naive, as 'Nothing comes easy in life without a price to pay."],
    ...
    ["Immerse myself in the allure of this captivating view from a foreign land. It serves as a poignant reminder for me to appreciate every little thing in my life and to consistently treat myself with compassion. A note to self echoes: 'Looking at beauty in the world is the first step in purifying the mind’."],
    ["Moonshot refers to a plan or aim to do something that seems almost impossible. It serves as a reminder that unless you dare to dream, a dream can change everything. It is bigger than you could ever imagine, but it is something you just can't ignore. It is a feeling deep in your gut."],
    ["Sometimes, I gaze at the evening sunset, an exquisite and calming marvel of nature. It's okay to stumble and face failures; life continues regardless. I always remind myself to keep my chin up, knowing that one day, I will overcome. The sunset prompts me to perceive the bright side of everything in life—even situations that seem unfavourable can hold hidden goodness. Don't let a single negative incident steal my smile, for there's always light at the end of the tunnel. Instead of tears for its end, smile for its occurrence."],
    ["A small treat of discovering a beautiful little flower from my neighbour's garden on one of my weekends. Taking photographs to showcase its beauty cherished my day."],
    ["Having a gathering while enjoying my favourite food and letting go of my feelings is good for my mental health. Food unites everyone regardless of culture; food makes us happy. Being in this place is special to me because I can feel the warmth and energy in the crowd. This place gathers friends and loved ones while enjoying good food. Sometimes it is okay to feel burned out; remember to go out, have fun, and relax, and do not be too hard on yourself. Learn to enjoy the little things in life; life is too short for us to worry. Just follow the flow and don’t think too much; enjoy the food and company like the one here."],
    ["The perpetual turning of the Ferris Wheel of life encapsulates us in the eternal torture of repetition with the yearning for signs of metamorphosis. Scavenging for stimulants, yet being unconsciously desensitised towards it, morphing into a punishment by Dopamine. Though the emancipation brought forward by Endorphin is obvious, even trivial, who if any would like to embark on such a journey? One must imagine Sisyphus happy, one must imagine oneself, free. Though the ephemeral sunset, and so is our gratification and anguish, one must remember, of the good thing, that is scattered yet omnipresent."],
    ["Walking at night is therapeutic; the cold breeze is relaxing. As I stroll through the park, I get to unwind my mind and immerse myself in nature. I have learned that life is not always straightforward and rosy but rather full of trials and challenges. It is up to us to make the most out of these experiences, becoming better individuals and learning from each one. Don't be afraid to explore new things because life becomes monotonous when you remain within the confines of what you already know"],
    ...
    [`My friend took this photo and sent it to me with the message: 'One day you will shine beautifully somewhere you didn't expect. Embracing Life's Transitions. Just as the rose finds its beauty under the fading light, remember that even in moments of change and uncertainty, there is a quiet strength within you. Each transition is a step toward a new dawn, where your resilience blooms.`],
    [`Throughout our lives, people must endure numerous trials, experience gatherings and partings, tread through perilous paths and fiery trials, and constantly engage in a battle against an intangible self—whether it be their past self or an imagined self. Yet, even amidst the desert, you can still become that rose. This rose doesn't necessarily have to be red; it could also be blue, green, yellow, white, purple, or even transparent. You are yourself, and in that, you are also your own hero.`],
    [`The lockdowns in 2020-2021 were a tumultuous time filled with uncertainty. On the bright side, I rediscovered drawing as a creative outlet and a way to reduce screen time. To this day, drawing continues to bring me a great sense of peace.`,`The use of a semicolon here is symbolic; it represents hope and the continuation of life for those facing mental health challenges. According to Project Semicolon, "A semicolon is used when an author could've chosen to end their sentence but chose not to. The author is you, and the sentence is your life.`,`The flowers growing from the semicolon signify new life, and it's also a testament to my love for drawing plants. This visual reminder reassures us that tough times will pass. Always remember, you're not alone; reach out to those you trust.`],
    ...
    [`My feelings needed an outlet; they guided my painting. Through painting, I saved myself from the abyss, stroke by stroke, bit by bit, inch by inch. I emerged from it.`],
